...
#define MT_GUI MT(MOD_LCTL | MOD_LSFT, KC_LGUI)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [0] = KEYMAP(
	       TD(TD_GRV_ESC),   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_NO, KC_BSPC, \
	       KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, \
	       TT(1),   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  \
	       KC_LSFT, KC_NO,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_NO,  \
	       KC_LCTL, LSFT(KC_LCTL),  KC_LALT,          KC_SPC,                                      KC_RALT, MO(1),   KC_LGUI,  KC_RCTL),
  ...
  [1] = KEYMAP(
      ...
      /*   lctrl,     pn,     lalt,               space,                                                              ralt,    fnc,   gui,       rctrl */

};


qk_tap_dance_action_t tap_dance_actions[] = {
  // Tap once for graves mark (tick [`]), twice for ESC
